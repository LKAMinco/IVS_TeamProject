...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/usr/share/pixmaps/logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"QMenu:pressed {background-color: rgb(42, 213, 116);}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_dot.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Decimal separator</span></p></body></html>"))
        self.pushButton_dot.setText(_translate("MainWindow", "."))
        self.pushButton_dot.setShortcut(_translate("MainWindow", "."))
        self.pushButton_add.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Addition</span></p><p><span style=\" color:#25be62;\">-----------------------</span></p><p><span style=\" color:#ffffff;\">Sum of a and b</span></p></body></html>"))
        self.pushButton_add.setText(_translate("MainWindow", "+"))
        self.pushButton_add.setShortcut(_translate("MainWindow", "+"))
        self.pushButton_sub.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Subtraction</span></p><p><span style=\" color:#25be62;\">-------------------------------</span></p><p><span style=\" color:#ffffff;\">Difference of a and b</span></p></body></html>"))
        self.pushButton_sub.setText(_translate("MainWindow", "-"))
        self.pushButton_sub.setShortcut(_translate("MainWindow", "-"))
        self.pushButton_mul.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Multiplication</span></p><p><span style=\" color:#25be62;\">---------------------------</span></p><p><span style=\" color:#ffffff;\">Product of a and b</span></p></body></html>"))
        self.pushButton_mul.setText(_translate("MainWindow", "x"))
        self.pushButton_mul.setShortcut(_translate("MainWindow", "*"))
        self.pushButton_div.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Division</span></p><p><span style=\" color:#25be62;\">-----------------------------</span></p><p><span style=\" color:#ffffff;\">Quotient of a and b</span></p></body></html>"))
        self.pushButton_div.setText(_translate("MainWindow", "/"))
        self.pushButton_div.setShortcut(_translate("MainWindow", "/"))
        self.pushButton_result.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Result</span></p></body></html>"))
        self.pushButton_result.setText(_translate("MainWindow", "="))
        self.pushButton_result.setShortcut(_translate("MainWindow", "Return"))
        self.pushButton_del.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Delete one character</span></p></body></html>"))
        self.pushButton_del.setText(_translate("MainWindow", "DEL"))
        self.pushButton_del.setShortcut(_translate("MainWindow", "Backspace"))
        self.pushButton_clear.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Clear all</span></p></body></html>"))
        self.pushButton_clear.setText(_translate("MainWindow", "C"))
        self.pushButton_clear.setShortcut(_translate("MainWindow", "Del"))
        self.pushButton_pow.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Power </span></p><p><span style=\" color:#ffffff;\">a^n</span></p><p><span style=\" color:#25be62;\">------------------------------------------</span></p><p><span style=\" color:#ffffff;\">a - base </span></p><p><span style=\" color:#ffffff;\">n - exponent</span></p><p><span style=\" color:#ffffff;\">Base raised to the exponent</span></p></body></html>"))
        self.pushButton_pow.setText(_translate("MainWindow", "^"))
        self.pushButton_sqr.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Root </span></p><p><span style=\" color:#ffffff;\">n√a</span></p><p><span style=\" color:#25be62;\">-------------------</span></p><p><span style=\" color:#ffffff;\">n-th root of a</span></p></body></html>"))
